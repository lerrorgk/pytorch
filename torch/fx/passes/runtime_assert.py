        ...
        for ra in ras:
            ...
            if missing:
                ...
                graph.call_function(
                    ...
                    (
                        res,
                        f"Runtime assertion failed for expression {sympy_printer.doprint(ra.expr)} on node '{res}'",
                    ),
                )
                    ...
                    if (
                        ...
                        if (min_val := convert(vr.lower)) is not None:
                            ...
                            graph.call_function(
                                ...
                                (
                                    ge,
                                    f"Runtime assertion failed for expression {sympy_printer.doprint(i0 >= min_val)} on node '{ge}'",
                                ),
                            )
                        ...
                        if (max_val := convert(vr.upper)) is not None:
                            ...
                            graph.call_function(
                                ...
                                (
                                    le,
                                    f"Runtime assertion failed for expression {sympy_printer.doprint(i0 <= max_val)} on node '{le}'",
                                ),
                            )
